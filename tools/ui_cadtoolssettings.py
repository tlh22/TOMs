...
class Ui_CadToolsSettings(object):
    def setupUi(self, CadToolsSettings):
        ...
        self.gridLayout = QtWidgets.QGridLayout(CadToolsSettings)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.buttonBox = QtWidgets.QDialogButtonBox(CadToolsSettings)
        ...
        self.gridLayout_2 = QtWidgets.QGridLayout(self.tabCurves)
        ...
        self.labelSplineTolerance = QtWidgets.QLabel(self.tab2)
        ...
        self.labelSplineTightness = QtWidgets.QLabel(self.tab2)
        ...
        spacerItem1 = QtGui.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, CadToolsSettings):
        CadToolsSettings.setWindowTitle(QtWidgets.QApplication.translate("CadToolsSettings", "CadTools Settings", None, QtWidgets.QApplication.UnicodeUTF8))
        self.groupBox.setTitle(QtWidgets.QApplication.translate("CadToolsSettings", "Feature Segmentation", None, QtWidgets.QApplication.UnicodeUTF8))
        self.radioFeaturePitch.setText(QtWidgets.QApplication.translate("CadToolsSettings", "Pitch", None, QtWidgets.QApplication.UnicodeUTF8))
        self.spinBoxFeaturePitch.setPrefix(QtWidgets.QApplication.translate("CadToolsSettings", "Millimeter(s) ", None, QtWidgets.QApplication.UnicodeUTF8))
        self.radioFeatureAngle.setText(QtWidgets.QApplication.translate("CadToolsSettings", "Angle", None, QtWidgets.QApplication.UnicodeUTF8))
        self.spinBoxFeatureAngle.setPrefix(QtWidgets.QApplication.translate("CadToolsSettings", "Degree(s) ", None, QtWidgets.QApplication.UnicodeUTF8))
        self.groupBox_2.setTitle(QtWidgets.QApplication.translate("CadToolsSettings", "Rubberband Segmentation", None, QtWidgets.QApplication.UnicodeUTF8))
        self.radioRubberAngle.setText(QtWidgets.QApplication.translate("CadToolsSettings", "Angle", None, QtWidgets.QApplication.UnicodeUTF8))
        self.spinBoxRubberAngle.setPrefix(QtWidgets.QApplication.translate("CadToolsSettings", "Degree(s) ", None, QtWidgets.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabCurves), QtWidgets.QApplication.translate("CadToolsSettings", "Arcs", None, QtWidgets.QApplication.UnicodeUTF8))
        self.labelSplineTolerance.setText(QtWidgets.QApplication.translate("CadToolsSettings", "Tolerance", None, QtWidgets.QApplication.UnicodeUTF8))
        self.spinBoxSplineTolerance.setToolTip(QtWidgets.QApplication.translate("CadToolsSettings", "Polyline interpolation tolerance in map units.", None, QtWidgets.QApplication.UnicodeUTF8))
        self.labelSplineTightness.setText(QtWidgets.QApplication.translate("CadToolsSettings", "Tightness", None, QtWidgets.QApplication.UnicodeUTF8))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab2), QtWidgets.QApplication.translate("CadToolsSettings", "Spline", None, QtWidgets.QApplication.UnicodeUTF8))
