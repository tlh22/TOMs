...
# Tool class
class intersectCircleKerb(QgsMapTool):

    pointFound = pyqtSignal(object)
    ...
    def canvasReleaseEvent(self,event):
        ...
        QgsMessageLog.logMessage(("In interesectCircleKerb."), tag="TOMs panel")
        ...
        if result:
            ...
            for i in range(segments):
                ...
                if i > 0:
                    QgsMessageLog.logMessage(("In createCircle. i: " + str(i) + " pt: "+ str(points[i].x()) + ": " + str(points[i].y())), tag="TOMs panel")
                    seg.setGeometry(QgsGeometry.fromPolyline([lastpoint, points[i]]))
