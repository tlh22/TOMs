'''
        Relevant parts of CadTools (from Stefan Ziegler)
...
class LineIntersectionTool():
        ...
        def __init__(self, iface,  toolBar):
            ...
            # Create actions 
            self.act_intersection= QAction(QIcon(":/plugins/Test5Class/resources/pointandline.png"),  QCoreApplication.translate("ctools", "Intersection Point"),  self.iface.mainWindow())
            self.act_s2s= QAction(QIcon(":/plugins/Test5Class/resources/select2lines.png"),  QCoreApplication.translate("ctools", "Select 2 Line Segments"),  self.iface.mainWindow())
            ...
            # TH: Store details of the current cursor
            # self.currCursor = self.canvas.cursor() 
        ...
        def s2s(self):
            ...
            # TH: Allow button to be checked on and off
            if not self.act_s2s.isChecked():
            ...
            # TH: Set up Cancel signal
            # self.tool.segmentsCancel.connect(self.cancelTool)
        ...
        '''                
        def cancelTool(self):
            # TH: Deal with Cancel signal
            # TQMessageBox.information(None,  "Cancel",  "Here now")
            # self.unsetTool()
            self.deactivate()                    
        '''             
        def deactivate(self):
            ...
            # TH: Reset the cursor type
            # self.canvas.setCursor(self.currCursor)
