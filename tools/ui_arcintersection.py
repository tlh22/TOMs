...
class Ui_ArcIntersection(object):
    def setupUi(self, ArcIntersection):
        ...
        self.horizontalLayoutWidget = QtWidgets.QWidget(ArcIntersection)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 20, 361, 41))
        self.horizontalLayoutWidget.setObjectName(_fromUtf8("horizontalLayoutWidget"))
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        self.horizontalLayout.setMargin(0)
        self.horizontalLayout.setObjectName(_fromUtf8("horizontalLayout"))
        self.lblPnt1 = QtWidgets.QLabel(self.horizontalLayoutWidget)
        ...
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(ArcIntersection)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(10, 80, 361, 41))
        self.horizontalLayoutWidget_2.setObjectName(_fromUtf8("horizontalLayoutWidget_2"))
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_2)
        self.horizontalLayout_2.setMargin(0)
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.lblPnt2 = QtWidgets.QLabel(self.horizontalLayoutWidget_2)
