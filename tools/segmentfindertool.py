...
class SegmentFinderTool(QgsMapTool):
  ...
  # TH: Set up cancel signal (not sure about "object")
  # segmentsCancel = pyqtSignal(object)
  ...
  def canvasReleaseEvent(self,event):
    ...
    #  TH: ***** May have to set this to the mapping layer to ensure we get relavent segments *****
  ...
  def deactivate(self):
    ...
    self.rb2.reset()
    self.count = 0
    # TH: Added Cancel signal ...
    # self.segmentsCancel.emit([""])
    pass
