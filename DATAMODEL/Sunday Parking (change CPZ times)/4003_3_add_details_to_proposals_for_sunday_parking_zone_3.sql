...
BEGIN
    ...
    LOOP
        ...
        INSERT INTO toms."RestrictionsInProposals"(
            ...
            VALUES (47, 2, 1, clone_restriction_id);

        -- Close
        INSERT INTO toms."RestrictionsInProposals"(
            "ProposalID", "RestrictionTableID", "ActionOnProposalAcceptance", "RestrictionID")
            VALUES (47, 2, 2, relevant_restriction."RestrictionID");
    ...
    LOOP
        ...
        INSERT INTO toms."RestrictionsInProposals"(
            "ProposalID", "RestrictionTableID", "ActionOnProposalAcceptance", "RestrictionID")
            VALUES (47, 3, 1, clone_restriction_id);

        -- Close
        INSERT INTO toms."RestrictionsInProposals"(
            "ProposalID", "RestrictionTableID", "ActionOnProposalAcceptance", "RestrictionID")
            VALUES (47, 3, 2, relevant_restriction."RestrictionID");
    ...
    LOOP
        ...
        INSERT INTO toms."RestrictionsInProposals"(
            "ProposalID", "RestrictionTableID", "ActionOnProposalAcceptance", "RestrictionID")
            VALUES (47, 4, 1, clone_restriction_id);

        -- Close
        INSERT INTO toms."RestrictionsInProposals"(
            "ProposalID", "RestrictionTableID", "ActionOnProposalAcceptance", "RestrictionID")
            VALUES (47, 4, 2, relevant_restriction."RestrictionID");
