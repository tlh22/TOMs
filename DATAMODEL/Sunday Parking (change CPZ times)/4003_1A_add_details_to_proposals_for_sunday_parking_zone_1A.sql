...
BEGIN
    ...
    LOOP
        ...
        INSERT INTO toms."RestrictionsInProposals"(
            ...
            VALUES (44, 2, 1, clone_restriction_id);

        -- Close
        INSERT INTO toms."RestrictionsInProposals"(
            "ProposalID", "RestrictionTableID", "ActionOnProposalAcceptance", "RestrictionID")
            VALUES (44, 2, 2, relevant_restriction."RestrictionID");
    ...
    LOOP
        ...
        INSERT INTO toms."RestrictionsInProposals"(
            "ProposalID", "RestrictionTableID", "ActionOnProposalAcceptance", "RestrictionID")
            VALUES (44, 3, 1, clone_restriction_id);

        -- Close
        INSERT INTO toms."RestrictionsInProposals"(
            "ProposalID", "RestrictionTableID", "ActionOnProposalAcceptance", "RestrictionID")
            VALUES (44, 3, 2, relevant_restriction."RestrictionID");
    ...
    LOOP
        ...
        INSERT INTO toms."RestrictionsInProposals"(
            "ProposalID", "RestrictionTableID", "ActionOnProposalAcceptance", "RestrictionID")
            VALUES (44, 4, 1, clone_restriction_id);

        -- Close
        INSERT INTO toms."RestrictionsInProposals"(
            "ProposalID", "RestrictionTableID", "ActionOnProposalAcceptance", "RestrictionID")
            VALUES (44, 4, 2, relevant_restriction."RestrictionID");
