...
-- Bridges
--
CREATE SEQUENCE "highway_asset_lookups"."BridgeTypes_Code_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "highway_asset_lookups"."BridgeTypes" OWNER TO "postgres";

ALTER TABLE highway_asset_lookups."BridgeTypes"
    ADD PRIMARY KEY ("Code");
