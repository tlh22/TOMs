...
INHERITS ("moving_traffic"."Restrictions"
          --, moving_traffic."NetworkReference"
          );
...
CREATE SEQUENCE "moving_traffic"."CarriagewayMarking_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE "moving_traffic"."CarriagewayMarkings" (
    "CarriagewayMarkingType_1" integer,
    ...
    "GeometryID" character varying(12) DEFAULT ('M_'::"text" || "to_char"("nextval"('"moving_traffic"."CarriagewayMarking_id_seq"'::"regclass"), '000000000'::"text"))
        "GeometryID" character varying(12) DEFAULT ('V_'::"text" || "to_char"("nextval"('"moving_traffic"."TurnRestrictions_id_seq"'::"regclass"), '000000000'::"text"))
)
INHERITS ("moving_traffic"."Restrictions"
          --, moving_traffic."NetworkReference"
...
-- Trigger: create_geometryid_trigger

-- DROP TRIGGER create_geometryid_trigger ON public."CarriagewayMarkings";

CREATE TRIGGER create_geometryid_carriageway_markings
    AFTER INSERT
