...
DROP TRIGGER IF EXISTS insert_mngmt ON toms."RestrictionPolygons";
DROP TRIGGER IF EXISTS insert_mngmt ON toms."ControlledParkingZones";
DROP TRIGGER IF EXISTS insert_mngmt ON toms."ParkingTariffAreas";
