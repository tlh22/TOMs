...
from qgis.core import Qgis, QgsFeature, QgsFeatureRequest, QgsGeometry, QgsRectangle
...
class TOMsProposal(ProposalTypeUtilsMixin, QObject):
    ...
    def __getRestrictionsInProposalForLayerForAction(
        ...
        ) in self.RestrictionsInProposalsLayer.getFeatures(request):
