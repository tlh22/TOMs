...
from qgis.core import NULL, Qgis, QgsGeometry, QgsPointXY, QgsWkbTypes
        ...
        for i in range(len(line) - 1):
            ...
            if i == 0:
                ...
                if restGeomType in [5, 25, 9, 29]:  # echelon
                    ...
                    if not self.is_float(orientation):
                ...
                raise Exception("Inspecter le code ici car après il y a des variables non définies")
