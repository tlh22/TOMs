...
class formCamera(QObject):
    ...
    def __init__(
        ...
        TOMsMessageLog.logMessage(
            "In formCamera::rotate_camera: {}".format(self.rotate_camera),
            level=Qgis.Info,
        )
    ...
    def identify(self):
        QMessageBox.information(
            ...
            "Hello, I am a camera path:{} photo:{} ...".format(
                self.path_absolute, self.currFileName
            ),
            QMessageBox.Ok,
        )
    ...
    def useCamera(self):
        ...
        self.camera.startCamera(
            self.cameraNr, self.frameWidth, self.frameHeight, self.rotate_camera
        )
