...
class RestrictionFormUtils(QtWidgets.QDialog):
    ...
    """def onAttributeChanged(self, feature, fieldName, value):
        #QgsMessageLog.logMessage("In restrictionFormOpen:onAttributeChanged - layer: " + str(layer.name()) + " (" + str(feature.attribute("GeometryID")) + "): " + fieldName + ": " + str(value), tag="TOMs panel", level=Qgis.Info)
    ...
    def photoDetails(self):
        ...
        QgsMessageLog.logMessage("In photoDetails. idx1: " + str(idx1) + "; " + str(idx2) + "; " + str(idx3), tag="TOMs panel", level=Qgis.Info)
