...
<qgis version="2.18.11" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="1">
    <rules key="{52f0a068-208b-4c17-a365-dda816a4b8d8}">
      ...
      <rule filter="&quot;RestrictionTypeID&quot; = 3" key="{b2424cff-5926-4b07-ad07-bf3ebb268240}" symbol="4" label="Free Bays - No Limited Waiting"/>
      <rule filter="&quot;RestrictionTypeID&quot; = 3" key="{6c200c86-d7c7-4c0a-bf7b-01ce0117e3d5}" symbol="5" label="Limited Waiting (no charge)"/>
      <rule filter="&quot;RestrictionTypeID&quot; = 14" key="{ced42c21-643d-4bd0-8390-abefa0023834}" symbol="6" label="Loading Bays"/>
      <rule filter="&quot;RestrictionTypeID&quot; = 18" key="{5e49c093-af6a-4019-9ad0-b94ee580bb1f}" symbol="7" label="Motorcycle Bay (Visitors)"/>
      <rule filter="&quot;RestrictionTypeID&quot; = 23" key="{d8d164e2-48c3-433f-89a3-32e85e653250}" symbol="8" label="Bus Stand"/>
      <rule filter="&quot;RestrictionTypeID&quot; = 21" key="{282ff4a3-4936-4b58-8d5d-f03dac42cf26}" symbol="9" label="Pay and Display/Pay by Phone"/>
      <rule filter="&quot;RestrictionTypeID&quot; IN (1,2,4)" key="{e21ed869-e805-4428-8a13-69ae1068bec2}" symbol="10" label="Permit Holder Bays"/>
      <rule filter="&quot;RestrictionTypeID&quot; = 5" key="{9550120d-0184-4243-bcf7-78502071b7ce}" symbol="11" label="Shared Bays (Permit/Non-permit Holder bays)"/>
      <rule filter="&quot;RestrictionTypeID&quot; = 22" key="{677e4eb9-08b0-4170-9f46-140fddd6eb00}" symbol="12" label="Taxi Bays"/>
      <rule filter="&quot;RestrictionTypeID&quot; = 7" key="{d84e1c4b-22e1-4eba-9f06-5e7f4a1dcc91}" symbol="13" label="Bus Stop"/>
      <rule filter="&quot;RestrictionTypeID&quot; = 35" key="{6529ec78-70af-481f-b792-1c3a62b58d1a}" symbol="14" label="Crossing - Zebra"/>
      <rule filter="&quot;RestrictionTypeID&quot; = 36" key="{da8f0fc2-a5eb-4691-8f48-3a91f9c2f1bf}" symbol="15" label="Crossing - Pelican"/>
      <rule filter="&quot;RestrictionTypeID&quot; = 37" key="{7b792467-a81c-4c1d-a423-e6a74f9b28f9}" symbol="16" label="Crossing - Toucan"/>
      <rule filter="&quot;RestrictionTypeID&quot; = 38" key="{b6dbf345-8056-4a8c-9b06-677092007ef6}" symbol="17" label="Crossing - Puffin"/>
      <rule filter="&quot;RestrictionTypeID&quot; = 4" key="{905c7569-aba2-419e-929d-3a2266e8c970}" symbol="18" label="Buses Only"/>
      <rule filter="&quot;RestrictionTypeID&quot; = 8" key="{083ac000-e2cc-419e-8910-1803822cdbe5}" symbol="19" label="Car Club Bays"/>
      <rule filter="&quot;RestrictionTypeID&quot; = 10" key="{0127ece4-b3c6-4266-a73e-b5bbd4fadb13}" symbol="20" label="Disabled Bays (Blue Badge)"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="1">
        ...
        <layer pass="0" class="GeometryGenerator" locked="0">
          ...
          <prop k="geometryModifier" v=" generate_display_geometry(   &quot;RestrictionTypeID&quot; , &quot;GeomTypeID&quot;,  &quot;AzimuthToRoadCentreLine&quot;,  @BayOffsetFromKerb ,  @BayWidth )"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="4">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="60,102,130,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="1.26"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
