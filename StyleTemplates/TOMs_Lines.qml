...
<qgis version="2.18.11" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueRelation" name="RestrictionTypeID">
      <widgetv2config OrderByValue="0" AllowNull="0" FilterExpression="" UseCompleter="0" fieldEditable="1" Key="id" constraint="" Layer="LineRestrictionTypes20170914120936078" Value="description" labelOnTop="0" constraintDescription="" AllowMulti="0" notNull="0"/>
    </edittype>
    <edittype widgetv2type="ValueRelation" name="NoWaitingTimeID">
      <widgetv2config OrderByValue="0" AllowNull="0" FilterExpression="" UseCompleter="0" fieldEditable="1" Key="PK_UID" constraint="" Layer="TimePeriods20170823071657575" Value="Description" labelOnTop="0" constraintDescription="" AllowMulti="0" notNull="0"/>
    </edittype>
    <edittype widgetv2type="ValueRelation" name="NoLoadingTimeID">
      <widgetv2config OrderByValue="0" AllowNull="0" FilterExpression="" UseCompleter="0" fieldEditable="1" Key="PK_UID" constraint="" Layer="TimePeriods20170823071657575" Value="Description" labelOnTop="0" constraintDescription="" AllowMulti="0" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="lines_word">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="ValueRelation" name="GeomShapeID">
      <widgetv2config OrderByValue="0" AllowNull="0" FilterExpression="" UseCompleter="0" fieldEditable="1" Key="Code" constraint="" Layer="RestrictionGeometryTypes20170823071627965" Value="Description" labelOnTop="0" constraintDescription="" AllowMulti="0" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{5e1ea33b-2b16-4512-a88f-15c10691064d}">
      <rule checkstate="0" filter="LineTypeDe = 'Crossing - Pelican'" key="{e0f519c6-b089-4aed-b576-4b4c07cf1214}" symbol="0" label="Crossing - Pelican"/>
      <rule checkstate="0" filter="LineTypeDe = 'Crossing - Puffin'" key="{799289f4-0afa-4ebc-8451-40e9cc5eed22}" symbol="1" label="Crossing - Puffin"/>
      <rule checkstate="0" filter="LineTypeDe = 'Crossing - Signalised'" key="{9eab7730-8649-4cfb-a2cd-9602e74e6f12}" symbol="2" label="Crossing - Signalised"/>
      <rule checkstate="0" filter="LineTypeDe = 'Crossing - Unmarked and no signals'" key="{aa1e7469-63cc-46eb-8640-20f797eccc9e}" symbol="3" label="Crossing - Unmarked and no signals"/>
      <rule checkstate="0" filter="LineTypeDe = 'Crossing - Zebra'" key="{d547301d-6855-437f-9ec5-ea4ec203c5b5}" symbol="4" label="Crossing - Zebra"/>
      <rule filter=" &quot;RestrictionTypeID&quot; = 1" key="{97859899-5fc5-4e6d-a92d-dc8db3e7c197}" symbol="5" label="No Waiting (SYL) (Acceptable)"/>
      <rule checkstate="0" filter="(LineTypeDe = 'No Waiting (SYL) (Acceptable)' OR LineTypeDe = 'No Waiting (SYL) (Unacceptable)')&#xd;&#xa; AND &quot;NoLoadingT&quot; > 0" key="{61050846-bfe5-40a8-b92a-90a2faabbef2}" symbol="6" label="No Waiting (SYL) (Acceptable)"/>
      <rule filter=" &quot;RestrictionTypeID&quot; = 2" key="{c4f00ae0-d280-48bd-a0a8-2f6d862b0b8d}" symbol="7" label="No Waiting At Any Time (DYL)"/>
      <rule checkstate="0" filter="LineTypeDe = 'No Waiting At Any Time (DYL)' AND  &quot;NoLoadin_1&quot; > 0" key="{522825fd-4152-471d-86b1-e20c7e085a60}" symbol="8" label="No Waiting At Any Time (DYL)"/>
      <rule checkstate="0" filter="LineTypeDe = 'Unmarked Area (Acceptable)'" key="{c9ae42bf-07a8-4417-8244-a1249a3f36a7}" symbol="9" label="Unmarked Area (Acceptable)"/>
      <rule checkstate="0" filter="LineTypeDe = 'Unmarked Area (Unacceptable)'" key="{c0688dfe-379a-402a-930d-ad5b8b7399b4}" symbol="10" label="Unmarked Area (Unacceptable)"/>
      <rule checkstate="0" filter="LineTypeDe = 'Zig Zag - School'" key="{7aa3e317-1477-49b9-92ed-05e52fa9070f}" symbol="11" label="Zig Zag - School"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="NoWaitingTimeID" index="3" name=""/>
    <alias field="NoLoadingTimeID" index="4" name=""/>
    <alias field="notes" index="5" name=""/>
    <alias field="GeometryID" index="6" name=""/>
    <alias field="lines_word" index="7" name=""/>
    <alias field="RoadName" index="8" name=""/>
    <alias field="USRN" index="9" name=""/>
    <alias field="AzimuthToRoadCentreLine" index="10" name=""/>
    <alias field="OpenDate2" index="11" name=""/>
    <alias field="CloseDate2" index="12" name=""/>
    <alias field="GeomShapeID" index="13" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="RestrictionTypeID"/>
      <column width="-1" hidden="0" type="field" name="NoWaitingTimeID"/>
      <column width="-1" hidden="0" type="field" name="NoLoadingTimeID"/>
      <column width="-1" hidden="0" type="field" name="notes"/>
      <column width="-1" hidden="0" type="field" name="GeometryID"/>
      <column width="-1" hidden="0" type="field" name="lines_word"/>
  ...
  <editform>./Form_Lines.ui</editform>
  <editforminit/>
...
def my_form_open(dialog, layer, feature):
  ...
  <widgets>
    ...
    <widget name="linetype">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="noloadingt">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
    </widget>
    <widget name="nowaitingt">
      <config>
        <option key="IsMultiline" value="false"/>
        <option key="UseHtml" value="false"/>
      </config>
  ...
  <defaults>
    ...
    <default field="NoWaitingTimeID" expression=""/>
    <default field="NoLoadingTimeID" expression=""/>
    <default field="notes" expression=""/>
    <default field="GeometryID" expression=""/>
    <default field="lines_word" expression=""/>
