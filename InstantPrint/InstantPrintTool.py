...
class InstantPrintTool(QgsMapTool, InstantPrintDialog):
    ...
    def __init__(self, iface, populateCompositionFz=None):
        ...
        self.dialogui.comboBox_fileformat.addItem("SVG", self.tr("SVG Image (*.svg);;"))
        ...
        self.dialogui.comboBox_scale.lineEdit().textChanged.connect(self.__changeScale)  # TODO: sort out what scales are available ...
